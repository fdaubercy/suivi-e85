...
## Corpus Check
- 4 files · ~705,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2626 nodes · 4438 edges · 352 communities (172 shown, 180 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.79)
- Token cost: 0 input · 77,249 output
...
- **Enrichissement W89 de la jauge (A1/A2/A3)** — changelog_a1_date_estimee, changelog_a2_accessibilite_jauges, changelog_a3_tooltip_jauge [EXTRACTED 1.00]
- **Trois jauges avec ARIA progressbar (A2)** — js_stats_buildrentabar, js_stats_buildco2annuel, js_stats_buildbudgetbar [EXTRACTED 1.00]

## Communities (352 total, 180 thin omitted)
...
Cohesion: 0.08
Nodes (40): getAllRecords(), buildBudgetBar(), buildBudgetTrend(), buildCo2Monthly(), buildCO2Tile(), buildFuelSeries(), buildMonthlyReport(), buildPrediction() (+32 more)
...
Cohesion: 0.13
Nodes (33): viewchange event, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+25 more)
...
Cohesion: 0.12
Nodes (31): DOM helper functions, applyPricesResult(), _cget(), _ck(), _cset(), fetchNearestE85Price(), fetchPricesAtCoords(), fetchPricesByCP() (+23 more)
...
Cohesion: 0.14
Nodes (29): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, promptLogin(), APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), _getClientId() (+21 more)
...
Cohesion: 0.16
Nodes (23): ALERT_FUELS, buildFuelRows(), checkPrixAlert(), checkPrixE85Alert(), _defOf(), ensurePermission(), getSeuil(), initNotifications() (+15 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (27): CHANGELOG — Suivi Conso Carburants, modSuiviVehicule.bas, v5.21.0.0, 🎯 Améliorations significatives, Axe Web app, 🎯 Backend (GAS), 🛠️ Dev / Outillage Claude, ROADMAP — Suivi E85 (+19 more)
...
Cohesion: 0.19
Nodes (19): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch(), ensureGis() (+11 more)
...
Cohesion: 0.15
Nodes (19): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs) (+11 more)
...
Cohesion: 0.15
Nodes (15): CHANGELOG v5.13.0.0, scripts/check_vba_drift.py, Top 5 recommandés (priorités ROADMAP), Lesson: never CStr() a real date for re-parsing, Lesson: timeline SetFilterDateRange ignores fractional dates, C11 — Cohérence FuelKeyK E10/GPLc, C9 — Service account Google (Top 5 #1), Top 5 recommandés en priorité (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.22
Nodes (12): _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), getBannerSurconso(), seuilRentable(), surconsoVsRef() (+4 more)
...
Cohesion: 0.18
Nodes (17): A2 — accessibilité ARIA des jauges, A3 — tooltip title de la jauge, buildRentaBar (js/stats.js), Coût total de conversion, Économie brute cumulée, Économie nette, Gate a11y W81, Jauge « Atteinte de rentabilité » (W89) (+9 more)
...
Cohesion: 0.15
Nodes (13): Gate pré-commit /graphify --update, devDependencies, eslint, @eslint/js, husky, jsdom, vite, vitest (+5 more)
...
Cohesion: 0.21
Nodes (11): A1 — date estimée de rentabilité, .renta-eta (ligne date estimée), clampSurconso(), computeStats(), champ e85SpanMonths (computeStats), getCoutPoste(), getCoutTotalConversion(), getEcartRef() (+3 more)
...
Cohesion: 0.39
Nodes (8): _getNum(), initBadges(), _markSeen(), refreshBadges(), SECTOR_FUELS, _setBadge(), _todayIso(), getPermission()
...
Cohesion: 0.22
Nodes (9): Constantes CO2 (W40/W51), DEFAULT_SURCONSO, buildCo2Annuel(), computeCo2Annuel(), computeSurconso(), getObjectifCo2(), getSurconsoFallback(), initCo2ObjectifSetting() (+1 more)
...
Cohesion: 0.33
Nodes (4): Job CI a11y (bloquant W81), Gate a11y bloquant (W81) — 0 violation grave, W79 — Audit a11y axe-core WCAG A/AA, VUES
...
Cohesion: 0.67
Nodes (3): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), X64 — Styles de galerie ChartStyle
...
## Knowledge Gaps
- **889 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+884 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 21` to `Community 153`, `Community 38`, `Community 39`, `Community 43`, `Community 78`, `Community 111`, `Community 112`, `Community 81`, `Community 62`, `Community 57`, `Community 30`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 38` to `Community 83`, `Community 163`, `Community 165`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 68` to `Community 104`, `Community 60`, `Community 69`, `Community 135`?**
