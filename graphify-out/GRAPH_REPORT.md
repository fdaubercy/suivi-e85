...
## Corpus Check
- 6 files · ~705,057 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2617 nodes · 4416 edges · 344 communities (163 shown, 181 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 279 edges (avg confidence: 0.79)
- Token cost: 0 input · 92,226 output
...
- **Jauge d'atteinte de rentabilité (données + rendu)** — changelog_jauge_atteinte_rentabilite, changelog_economie_brute, changelog_cout_total_conversion, changelog_build_renta_bar [EXTRACTED 1.00]
- **Comparaison E85 vs diesel (W89, web↔Excel↔GAS)** — changelog_comparaison_e85_diesel, changelog_refmodel_js, changelog_carburant_ref, changelog_param_keys_whitelist, changelog_co2_diesel_aware [EXTRACTED 1.00]
...
Cohesion: 0.11
Nodes (47): DOM helper functions, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+39 more)
...
Cohesion: 0.07
Nodes (36): OCR ticket parsing logic, Pure utility functions, detectBrand(), applyTicketStation(), fillFormFromTicket(), _findStationInCommune(), FRENCH_MONTHS, FUEL_LABEL_MAP (+28 more)
...
Cohesion: 0.09
Nodes (31): buildBudgetBar(), buildBudgetTrend(), buildCO2Tile(), buildFuelSeries(), buildPrediction(), buildPrixSparkline(), buildRentaBar(), buildSparklineSVG() (+23 more)
...
Cohesion: 0.11
Nodes (32): CHANGELOG — Suivi Conso Carburants, v5.13.0.0, Top 5 recommandés (priorités ROADMAP), Axe Excel, Axe Web app, 🎯 Backend (GAS), C11 — Cohérence FuelKeyK E10/GPLc, C9 — Service account Google (Top 5 #1) (+24 more)
...
Cohesion: 0.17
Nodes (25): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, getIdToken(), APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), _getClientId() (+17 more)
...
Cohesion: 0.16
Nodes (21): calcTriplet(), setVehiculeStatus(), _autoSelectLastVehicule(), chargerVehicules(), confirmerAjoutVehicule(), getVehicules(), onVehiculeChange(), _populateGlobalVehiculeSelect() (+13 more)
...
Cohesion: 0.12
Nodes (24): hideMap, initMapInteractions, carte.js, showMap, showPinLabel, tileXY, Modèle CO2 E85 vs essence (tank-to-wheel), E85_RENTABLE_RATIO (+16 more)

### Community 32 - "Community 32"
Cohesion: 0.13
Nodes (24): EnsureGSHeaders (X48 garde-fou en-têtes), modGraphBlocks, modSyncCfg.bas — config sync Public Const, modSyncDiag, modSyncEngine.bas (SyncCore import/export), modSyncExport, modSyncGS.bas (sync Google Sheets), modSyncJson.bas (helpers JSON/format) (+16 more)
...
Cohesion: 0.14
Nodes (20): Code.gs (doGet dispatcher GAS), Dashboard.gs (construireDashboard), W80 — synchronisation hors-ligne debloquee, W82 — versionnage Service Worker / feedback badge hors-ligne, config.js (Configuration globale), APP_TOKEN, APP_VERSION, Seuil de rentabilité E85 vs SP98 (ratio 0.66 / surconso) (+12 more)
...
Cohesion: 0.17
Nodes (15): viewchange event, initCsvSepSetting(), initHistoireFilters(), initHistoireShare(), _refreshVehBar(), t, chargerStations(), _gsStations (+7 more)
...
Cohesion: 0.13
Nodes (13): Job CI a11y (bloquant W81), Gate a11y bloquant (W81) — 0 violation grave, Content-Security-Policy (index.html), Sync hors-ligne (offline.js, W80/W82), PWA / Service Worker (SW versionné W23/W82), Router SPA par hash (#/vue), U7 — Authentification Google (GIS multi-utilisateur), W79 — Audit a11y axe-core WCAG A/AA (+5 more)
...
Cohesion: 0.19
Nodes (14): ClassifyFilterDelta (rsNone/rsTargeted/rsFull), modFiltres.DebouncedRebuild, Cellule _GraphData!ZZ1 (stockage signature), Empreinte des données source (SourceFingerprint Tableau2/GS_Pleins), Signature d'état (ComputeRebuildSignature), X43c — Rebuild dashboard incrémental hybride, ClassifyFilterDelta (rsNone/rsTargeted/rsFull), ComputeRebuildSignature() (+6 more)

### Community 58 - "Community 58"
Cohesion: 0.18
Nodes (14): buildRentaBar (js/stats.js), Coût total de conversion, Économie brute cumulée, Économie nette, Jauge « Atteinte de rentabilité » (W89), Jauges existantes (gauge-track/gauge-tick/gauge-scale), % d'amortissement de la conversion, .renta-* styles (css/style.css) (+6 more)
...
Cohesion: 0.18
Nodes (13): Constantes CO2 (W40/W51), DEFAULT_SURCONSO, buildMonthlyReport(), clampSurconso(), computeStats(), computeSurconso(), getEcartRef(), getSurconsoFallback() (+5 more)
...
Cohesion: 0.29
Nodes (9): _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), state, escHtml(), haversine() (+1 more)
...
Cohesion: 0.32
Nodes (7): CreerGraphiquesWeb (chemin rebuild complet), Tableau de bord Excel, Filtres natifs dashboard (segments véhicule/carburant + chronologie), BuildConsoBlock (gConso multi-vehicule), BuildPriceBlockMerged (gPrice multi-carburant), Perimetre pragmatique : Vehicule -> gConso seul, Filtre Periode (B9/B10, PERIODE_DEB/FIN)
...
Cohesion: 0.29
Nodes (7): Job CI audit (npm audit, non-bloquant), Job CI coverage (Vitest, non-bloquant), Job CI lint (ESLint), Job CI test (Vitest), Job CI version-check (APP_VERSION vs tag Git), Workflow CI GitHub Actions, .github/workflows/ci.yml — CI Lint/Tests/Version
...
## Knowledge Gaps
- **886 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+881 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 16` to `Community 34`, `Community 67`, `Community 43`, `Community 80`, `Community 81`, `Community 147`, `Community 148`, `Community 53`, `Community 52`, `Community 83`, `Community 89`, `Community 125`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 69` to `Community 98`, `Community 19`, `Community 71`, `Community 130`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 34` to `Community 103`, `Community 63`?**
