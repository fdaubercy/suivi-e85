...
## Corpus Check
- 7 files · ~708,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2714 nodes · 4687 edges · 341 communities (158 shown, 183 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 293 edges (avg confidence: 0.79)
- Token cost: 0 input · 73,773 output
...
6. `state` - 33 edges
7. `getAllRecords()` - 32 edges
8. `FUEL_CONFIG` - 25 edges
9. `renderStats()` - 25 edges
10. `fetchPricesAtCoords()` - 24 edges

## Surprising Connections (you probably didn't know these)
- `X40 — Lint VBA pré-commit` --conceptually_related_to--> `package.json (v5.30.5.0, Vite/Vitest)`  [INFERRED]
  CHANGELOG.md → package.json
- `renderItem()` --references--> `.hist-conso.eco/.mid/.high (classes couleur)`  [INFERRED]
  js/historique.js → css/style.css
...
- **Implémentation conso colorée relative médiane (W90)** — js_historique_computeconsobyfill, js_historique_median, concept_conso_level_thresholds, css_style_hist_conso_levels, js_historique_renderitem [EXTRACTED 1.00]
- **Extension 5→10 derniers pleins** — js_historique_recent_count, index_10_derniers_pleins, js_historique_renderitem [INFERRED 0.85]

## Communities (341 total, 183 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (79): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson() (+71 more)
...
Cohesion: 0.06
Nodes (54): Repli OpenStreetMap (onFallback), brandIconUrl(), brandInfo(), BRANDS, detectBrand(), GENERIC_BRAND_ICON, _logUnknownBrand(), _unknownSeen (+46 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (47): viewchange event, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), checkDuplicate(), initVoiceKm(), onKmInput() (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (42): DOM helper functions, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+34 more)
...
Cohesion: 0.06
Nodes (46): C9 reporté (compte de service Google), carburant_ref (libellé SP98/SP95/E10), Clamp surconso [0,15 ; 0,40], COUT_TOTAL (Name dérivé), ecart_ref (écart €/L vs SP98), Postes de coût one-off (boîtier/pose/carte grise/entretien/assurance/aide), Date de rentabilité optimiste (J11), proj_nb_recents (N pleins récents) (+38 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (39): Constantes CO2 (W40/W51), DEFAULT_SURCONSO, buildBudgetBar(), buildBudgetTrend(), buildFuelSeries(), buildMonthlyReport(), buildPrixSparkline(), buildSparklineSVG() (+31 more)
...
Cohesion: 0.08
Nodes (35): Stats cache TTL & freshness, calculerStatsRapport(), construireUrlGraphePrix(), buildStatsUrl(), getCachedServerStats(), getServerStats(), isFresh(), prewarmServerStats() (+27 more)
...
Cohesion: 0.12
Nodes (31): CHANGELOG — Suivi Conso Carburants, v5.13.0.0, Artifact GAS Manager / gas-config.json, Top 5 recommandés (priorités ROADMAP), Axe Dev / Outillage Claude, Axe Web app, C11 — Cohérence FuelKeyK E10/GPLc, C4 Pouvoirs navigateur Claude in Chrome (+23 more)
...
Cohesion: 0.11
Nodes (26): PRIX_API (data.economie.gouv.fr), cacheStationCoords(), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle(), _ensureUserPos(), FUEL_TOKENS, _geocodeMissing() (+18 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (28): BuildAggregates, BuildConsoBlock, BuildPriceBlockMerged, BuildVehiculesBlock, C1 — Libellés « Super 95/98 », G1 — listes déroulantes saisie Excel, G3 — dashboard natif Sheets, W81 — a11y WCAG AA gate bloquant (+20 more)
...
Cohesion: 0.16
Nodes (24): getLastRecordSummary(), initCollapsibles(), initHomeResume(), initPreferences(), initStartViewSetting(), renderHomeResume(), VIEW_META, currentView() (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (25): v5.33.2.0 — Conso colorée + 10 derniers pleins (W90), Bornes de plausibilité [1;60] L/100, Calcul par véhicule (identité d'objet), Niveau couleur conso (eco/mid/high), Conso colorée relative à la médiane (W90), Seuils de couleur (médiane ×0,95 / ±5% / ×1,05), Consommation plein-à-plein L/100 km, getAllRecords (records historique) (+17 more)
...
Cohesion: 0.15
Nodes (16): buildComparatifCSV(), CMP_COLS, computeVehicleComparison(), exportComparatifCSV(), initComparatifExport(), renderComparateur(), _priceBadge(), _close() (+8 more)

### Community 32 - "Community 32"
Cohesion: 0.20
Nodes (23): buildBudgetBar(), buildBudgetTrend(), buildCo2Annuel(), buildCo2Monthly(), buildMonthlyReport(), computeBudgetForecast(), computeCo2Annuel(), computeCo2Monthly() (+15 more)
...
Cohesion: 0.12
Nodes (22): .bilan-* (css), #bilanSheetCard, getAllRecords(), buildCo2Annuel(), buildCo2Monthly(), buildCO2Tile(), buildPrediction(), computeCo2Annuel() (+14 more)

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (20): A1 — date estimée de rentabilité, A2 — accessibilité ARIA des jauges, A3 — tooltip title de la jauge, buildRentaBar (js/stats.js), Coût total de conversion, Économie brute cumulée, Économie nette, Gate a11y W81 (+12 more)
...
Cohesion: 0.17
Nodes (19): EnsureGSHeaders (X48 garde-fou en-têtes), modSyncCfg.bas — config sync Public Const, modSyncDiag, modSyncGS.bas (sync Google Sheets), modSyncJson.bas (helpers JSON/format), modSyncNet, modSyncParametres (dédupliqué), ModuleImportGS (+11 more)
...
Cohesion: 0.17
Nodes (17): FUEL_PRICE_COL, SPARK_COLORS, initBudgetSetting(), initCo2ObjectifSetting(), initRapport(), initRentabiliteSettings(), initSparkToggles(), buildFuelSeries() (+9 more)
...
Cohesion: 0.18
Nodes (16): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), modGraphData.bas (agrégats dashboard), modGraphiques.bas (orchestration dashboard), modGraphRender.bas (rendu graphiques/KPI), modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphChrome.bas, modGraphData.bas — moteur d'agregats (BuildAggregates) (+8 more)
...
Cohesion: 0.17
Nodes (15): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), gas-config.json, G5 — Auto-maintenance des listes de saisie, ModuleImportGS.ImporterNouveauxPleins (+7 more)

### Community 55 - "Community 55"
Cohesion: 0.15
Nodes (14): S5 — suppression d'un plein accessible utilisateur, X61 — dates FR des abscisses du Tableau de bord, commit.sh (gate Lint), Gate a11y bloquant (W81) — 0 violation grave, X44 — Modularisation gros modules VBA (< 500 l.), X53 — Nettoyage code mort économie E85, Règle : retirer Attribute VB_Name avant set-module, Règle : Const mal placée = erreur compile-on-demand (+6 more)
...
Cohesion: 0.18
Nodes (12): Release v5.33.0.0, GAS action=buildDashboard, buildDashboardUrl(), refreshDashboard(), sheetEditUrl(), initBilanSheet(), Shortcut « Carte des stations » (#/carte), Shortcut « Nouveau plein » (+4 more)
...
Cohesion: 0.15
Nodes (10): Job CI audit (npm audit, non-bloquant), Job CI coverage (Vitest, non-bloquant), Job CI a11y (bloquant W81), Job CI lint (ESLint), Job CI test (Vitest), Job CI version-check (APP_VERSION vs tag Git), Workflow CI GitHub Actions, .github/workflows/ci.yml — CI Lint/Tests/Version (+2 more)
...
Cohesion: 0.21
Nodes (12): Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs), jsrsasign (JWT ES256 P-256), Alertes prix par carburant (W11/W49), Prix payé vs moins cher du secteur (W38), RefreshPrix.gs (relevé quotidien S8/W38), WebPush.gs (Web Push VAPID S10) (+4 more)
...
Cohesion: 0.36
Nodes (8): buildRefModel(), computeConsoMoy(), matchType(), resolveConsoDiesel(), getCarburantRef(), getEcartRef(), getRefModelForStats(), recE85
...
Cohesion: 0.32
Nodes (8): modDashboardKPI.bas (ConsoL100, ComputeDashboardStats), X45 — tests unitaires VBA modTests.bas, X53 — nettoyage code mort éco E85 (v5.30.6.0), CO2 Constants, DEFAULT_SURCONSO, CO2 E85 vs essence (W40/W51), computeSurconso, stats.js
...
Cohesion: 0.33
Nodes (7): computeStats(), surconsoVsRef(), getCoutPoste(), getCoutTotalConversion(), getKitPrix(), surconsoVsRef(), initKitSetting()
...
Cohesion: 0.40
Nodes (6): Carburant de référence (SP98/SP95/E10/GAZOLE), CO₂ évité diesel-aware (facteur 2,68 kg/L), Comparaison E85 vs diesel (W89), vba/modRentabilite.bas, GAS PARAM_KEYS whitelist (Code.gs), js/refmodel.js — modèle de référence unifié
...
Cohesion: 0.33
Nodes (4): [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, Added — 🌿 Badge rentabilité E85 (ROADMAP W5), Added — 📈 Stats live (ROADMAP W7)
...
Cohesion: 0.50
Nodes (4): modGraphBlocks, modSyncEngine.bas (SyncCore import/export), modSyncExport, X44 Phase 4
...
## Knowledge Gaps
- **899 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+894 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 19` to `Community 67`, `Community 73`, `Community 139`, `Community 140`, `Community 43`, `Community 77`, `Community 117`, `Community 54`, `Community 55`, `Community 152`, `Community 151`, `Community 26`, `Community 62`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 73` to `Community 60`, `Community 78`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 70` to `Community 48`, `Community 121`, `Community 13`, `Community 95`?**
