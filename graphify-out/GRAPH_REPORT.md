...
## Corpus Check
- 6 files · ~708,965 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2722 nodes · 4700 edges · 347 communities (166 shown, 181 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.79)
- Token cost: 0 input · 69,057 output
...
- **Refonte coloration conso par carburant (W90)** — concept_per_fuel_conso_coloring, js_historique_fuelfamily, js_historique_computeconsobyfill, concept_fuel_family_grouping, rationale_flexfuel_e85_sp98 [EXTRACTED 1.00]
...
Cohesion: 0.06
Nodes (55): Repli OpenStreetMap (onFallback), brandIconUrl(), brandInfo(), BRANDS, detectBrand(), GENERIC_BRAND_ICON, _logUnknownBrand(), _unknownSeen (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (57): .bilan-* (css), #bilanSheetCard, Constantes CO2 (W40/W51), DEFAULT_SURCONSO, getAllRecords(), buildBudgetBar(), buildBudgetTrend(), buildCo2Annuel() (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (52): Offline sync queue — localStorage queue for failed GAS POSTs, viewchange event, submitForm, promptLogin(), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), checkDuplicate() (+44 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (48): [2.12.0.0] — 2026-05-27, [2.12.1.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.15.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.5.1] — 2026-05-25, [2.5.0.0] — 2026-05-25 (+40 more)
...
Cohesion: 0.13
Nodes (40): DOM helper functions, Historical price resolution — nearest-prior sector/station price for past fills, _buildTypeToggle(), _updateHeaderBadges(), onStationChange(), resetForm(), applyPricesResult(), _cget() (+32 more)
...
Cohesion: 0.05
Nodes (41): [2.11.0.0] — 2026-05-27, [2.16.0.0] — 2026-05-28, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26, [3.0.0.2] — 2026-05-28 (+33 more)
...
Cohesion: 0.13
Nodes (18): _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), buildComparatifCSV(), CMP_COLS, computeVehicleComparison(), exportComparatifCSV() (+10 more)
...
Cohesion: 0.19
Nodes (24): buildBudgetBar(), buildBudgetTrend(), buildCo2Annuel(), buildCo2Monthly(), buildMonthlyReport(), computeBudgetForecast(), computeCo2Annuel(), computeCo2Monthly() (+16 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (25): BuildAggregates, BuildConsoBlock, BuildPriceBlockMerged, BuildVehiculesBlock, C1 — Libellés « Super 95/98 », G1 — listes déroulantes saisie Excel, G3 — dashboard natif Sheets, W81 — a11y WCAG AA gate bloquant (+17 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (25): CHANGELOG — Suivi Conso Carburants, modSuiviVehicule.bas, v5.21.0.0, Suivi véhicule (modSuiviVehicule.bas, multi-véhicule), Axe Web app, 🎯 Backend (GAS), 🛠️ Dev / Outillage Claude, ROADMAP — Suivi E85 (+17 more)
...
Cohesion: 0.14
Nodes (20): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), modGraphData.bas (agrégats dashboard), modGraphiques.bas (orchestration dashboard), modGraphRender.bas (rendu graphiques/KPI), modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphChrome.bas, modGraphData.bas — moteur d'agregats (BuildAggregates) (+12 more)
...
Cohesion: 0.13
Nodes (17): buildHistoriqueCSV(), _consoByKey, CSV_COLS, _csvSep(), _downloadCSV(), estPleinValide(), exportHistoriqueAllCSV(), exportHistoriqueCSV() (+9 more)

### Community 35 - "Community 35"
Cohesion: 0.15
Nodes (21): A1 — date estimée de rentabilité, A2 — accessibilité ARIA des jauges, A3 — tooltip title de la jauge, buildRentaBar (js/stats.js), Coût total de conversion, Économie brute cumulée, Économie nette, Gate a11y W81 (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (21): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs) (+13 more)
...
Cohesion: 0.16
Nodes (18): forceRefreshHistorique(), FUEL_PRICE_COL, SPARK_COLORS, initBudgetSetting(), initRapport(), initRentabiliteSettings(), initSparkToggles(), buildFuelSeries() (+10 more)
...
Cohesion: 0.21
Nodes (15): CHANGELOG v5.13.0.0, Top 5 recommandés (priorités ROADMAP), Lesson: never CStr() a real date for re-parsing, Lesson: timeline SetFilterDateRange ignores fractional dates, Axe Excel, C11 — Cohérence FuelKeyK E10/GPLc, C9 — Service account Google (Top 5 #1), Top 5 recommandés en priorité (+7 more)

### Community 55 - "Community 55"
Cohesion: 0.16
Nodes (14): v5.33.2.0 — Conso colorée + 10 derniers pleins (W90), v5.33.3.0 — conso colorée par carburant (W90), Niveau couleur conso (eco/mid/high), Conso colorée relative à la médiane (W90), Seuils de couleur (médiane ×0,95 / ±5% / ×1,05), Véhicule flex-fuel (SP98 + E85), Médiane groupée par (véhicule × famille carburant), Seuil ≥ 3 pleins du même carburant sinon neutre (+6 more)
...
Cohesion: 0.20
Nodes (11): Bornes de plausibilité [1;60] L/100, Calcul par véhicule (identité d'objet), Consommation plein-à-plein L/100 km, getAllRecords (records historique), W90 — Conso L/100 km par plein, _allRecords, computeConsoByFill(), _consoFor() (+3 more)
...
Cohesion: 0.22
Nodes (10): plein-added event, chargerHistorique(), _loadSince(), renderFullHistory(), _renderLists(), rerenderHistorique(), _saveCache(), _saveSince() (+2 more)

### Community 88 - "Community 88"
Cohesion: 0.20
Nodes (10): .hist-conso (CSS), Titre « 10 derniers pleins » (index.html), escapeHtml(), fmtDate(), fmtKm(), getLastRecordSummary(), iconForType(), _loadCache() (+2 more)
...
Cohesion: 0.39
Nodes (6): FUEL_CONFIG, FUEL_KEYS, getBannerSurconso(), seuilRentable(), surconsoVsRef(), updateRentabilite()

### Community 98 - "Community 98"
Cohesion: 0.25
Nodes (9): computeStats(), getKitPrix(), initKitSetting(), surconsoVsRef(), getCoutPoste(), getCoutTotalConversion(), getKitPrix(), surconsoVsRef() (+1 more)
...
## Knowledge Gaps
- **901 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+896 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 26` to `Community 65`, `Community 36`, `Community 42`, `Community 43`, `Community 75`, `Community 109`, `Community 148`, `Community 149`, `Community 54`, `Community 86`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 36` to `Community 81`, `Community 58`, `Community 158`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 67` to `Community 131`, `Community 13`, `Community 102`, `Community 47`?**
