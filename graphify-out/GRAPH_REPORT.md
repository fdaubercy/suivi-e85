...
## Corpus Check
- 6 files · ~707,788 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2704 nodes · 4672 edges · 354 communities (171 shown, 183 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 291 edges (avg confidence: 0.79)
- Token cost: 0 input · 70,929 output
...
- **Implémentation W90 conso par plein** — concept_w90_conso_par_plein, js_historique_computeconsobyfill, js_historique_renderitem, css_style_hist_conso, tests_historique [EXTRACTED 1.00]

## Communities (354 total, 183 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (80): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, Offline sync queue — localStorage queue for failed GAS POSTs, plein-added event, submitForm, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml() (+72 more)
...
Cohesion: 0.09
Nodes (45): viewchange event, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (44): Repli OpenStreetMap (onFallback), bestZoom(), hideMap(), initMapInteractions(), latLonToPx(), _renderGoogleMap(), _renderMap(), renderMiniMap() (+36 more)
...
Cohesion: 0.08
Nodes (39): .bilan-* (css), #bilanSheetCard, buildBudgetBar(), buildBudgetTrend(), buildCO2Tile(), buildFuelSeries(), buildMonthlyReport(), buildPrixSparkline() (+31 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (37): Stats cache TTL & freshness, calculerStatsRapport(), construireUrlGraphePrix(), _localAnnualKpis(), renderServerSummary(), buildStatsUrl(), getCachedServerStats(), getServerStats() (+29 more)
...
Cohesion: 0.09
Nodes (33): PRIX_API (data.economie.gouv.fr), _priceBadge(), _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), CARTE_FUELS (+25 more)
...
Cohesion: 0.12
Nodes (29): DOM helper functions, applyPricesResult(), _cget(), _ck(), _cset(), fetchNearestE85Price(), fetchPricesAtCoords(), fetchPricesByCP() (+21 more)
...
Cohesion: 0.11
Nodes (26): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), modGraphData.bas (agrégats dashboard), modGraphiques.bas (orchestration dashboard), modGraphRender.bas (rendu graphiques/KPI), modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphChrome.bas, modGraphData.bas — moteur d'agregats (BuildAggregates) (+18 more)
...
Cohesion: 0.14
Nodes (26): CHANGELOG — Suivi Conso Carburants, v5.13.0.0, Top 5 recommandés (priorités ROADMAP), Axe Excel, Axe Web app, C11 — Cohérence FuelKeyK E10/GPLc, C9 — Service account Google (Top 5 #1), ROADMAP — Suivi E85 (+18 more)
...
Cohesion: 0.12
Nodes (23): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs) (+15 more)

### Community 31 - "Community 31"
Cohesion: 0.17
Nodes (22): Historical price resolution — nearest-prior sector/station price for past fills, _renderLists(), rerenderHistorique(), refreshAfterPlein(), applyHistPriceToForm — fill form with historical price for past date (W60), applyHistPriceToForm(), _cacheKey(), escapeHtml() (+14 more)
...
Cohesion: 0.14
Nodes (19): .hist-conso (CSS), _consoByKey, CSV_COLS, dupliquerDernier(), escapeHtml(), fmtDate(), fmtKm(), getLastRecordSummary() (+11 more)
...
Cohesion: 0.13
Nodes (18): Constantes CO2 (W40/W51), DEFAULT_SURCONSO, clampSurconso(), computeStats(), computeSurconso(), getCoutPoste(), getCoutTotalConversion(), getEcartRef() (+10 more)
...
Cohesion: 0.20
Nodes (15): ClassifyFilterDelta (rsNone/rsTargeted/rsFull), modFiltres.DebouncedRebuild, Cellule _GraphData!ZZ1 (stockage signature), Empreinte des données source (SourceFingerprint Tableau2/GS_Pleins), Signature d'état (ComputeRebuildSignature), X43c — Rebuild dashboard incrémental hybride, ComputeRebuildSignature(), DeverrouillerSuivi / VerrouillerSuivi (feuille protégée) (+7 more)

### Community 51 - "Community 51"
Cohesion: 0.21
Nodes (13): buildRefModel(), computeConsoMoy(), matchType(), resolveConsoDiesel(), buildCo2Annuel(), buildCo2Monthly(), computeCo2Annuel(), computeCo2Monthly() (+5 more)
...
Cohesion: 0.16
Nodes (13): Release v5.33.0.0, GAS action=buildDashboard, APP_TOKEN (S6 token partagé GAS/VBA), buildDashboardUrl(), refreshDashboard(), sheetEditUrl(), initBilanSheet(), Shortcut « Carte des stations » (#/carte) (+5 more)
...
Cohesion: 0.21
Nodes (10): ClassifyFilterDelta (rsNone/rsTargeted/rsFull), CreerGraphiquesWeb (chemin rebuild complet), Tableau de bord Excel, DebouncedRebuild, Filtres natifs dashboard (segments véhicule/carburant + chronologie), RebuildBlocks(blocks) — chemin ciblé, BuildConsoBlock (gConso multi-vehicule), BuildPriceBlockMerged (gPrice multi-carburant) (+2 more)
...
Cohesion: 0.24
Nodes (11): C9 reporté (compte de service Google), gas-config.json, Artifact GAS Manager / gas-config.json, Axe Dev / Outillage Claude, C10 — Hook PostToolUse Chrome, C3 — Sécurité .gitignore (gas-config.json), C4 Pouvoirs navigateur Claude in Chrome, C5 Pouvoirs API Google (GAS + Sheets) (+3 more)
...
Cohesion: 0.20
Nodes (10): modSuiviVehicule.bas, v5.21.0.0, GS_Pleins (table Power Query), Carte Rentabilité kit E85, Suivi véhicule (modSuiviVehicule.bas, multi-véhicule), ROADMAP X45 — Tests VBA fonctions pures, X49 Carte Rentabilite kit E85, X50 Suivi Carburant reactif au vehicule (+2 more)
...
Cohesion: 0.25
Nodes (9): Bornes de plausibilité [1;60] L/100, Calcul par véhicule (identité d'objet), Consommation plein-à-plein L/100 km, getAllRecords (records historique), W90 — Conso L/100 km par plein, _allRecords, computeConsoByFill(), _consoFor() (+1 more)
...
Cohesion: 0.22
Nodes (9): chargerHistorique(), exportHistoriqueCSV(), _filteredRecords(), forceRefreshHistorique(), _loadSince(), renderFullHistory(), _saveCache(), _saveSince() (+1 more)
...
Cohesion: 0.29
Nodes (7): commit.sh (gate Lint), Règle : retirer Attribute VB_Name avant set-module, Règle : Const mal placée = erreur compile-on-demand, Règle : garde anti-amputation graphify --update, tasks/lessons.md — Lessons Learned, commit.sh (gate version/lint/test), scripts/check_vba_compile.py
...
Cohesion: 0.29
Nodes (5): buildHistoriqueCSV(), _csvSep(), _downloadCSV(), estPleinValide(), exportHistoriqueAllCSV()
...
Cohesion: 0.70
Nodes (5): CHANGELOG 5.27.0.0 — X41 + X51, ImporterNouveauxPleinsAuto, X41 — garde-erreur Feuil2.Worksheet_Activate, Leçon #82 — set-doc timeout corrompt Feuil2 (X41), Feuil2 (doc-module « Suivi Carburant »)
...
Cohesion: 0.50
Nodes (4): GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), initHistoireDelete()

### Community 151 - "Community 151"
Cohesion: 0.50
Nodes (4): package suivi-conso-carburant (Vite/Vitest/Playwright), ROADMAP.md — Suivi E85, W79 — Audit accessibilité automatisé CI (axe-core), W81 — corriger violations a11y (select-name / color-contrast)
...
## Knowledge Gaps
- **896 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+891 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 23` to `Community 164`, `Community 165`, `Community 154`, `Community 39`, `Community 74`, `Community 75`, `Community 47`, `Community 21`, `Community 85`, `Community 153`, `Community 90`, `Community 60`, `Community 30`, `Community 127`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 30` to `Community 58`, `Community 78`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 64` to `Community 57`, `Community 10`, `Community 99`, `Community 133`?**
