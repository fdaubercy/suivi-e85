...
## Corpus Check
- 13 files · ~707,018 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2694 nodes · 4656 edges · 343 communities (162 shown, 181 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 287 edges (avg confidence: 0.79)
- Token cost: 0 input · 81,024 output
...
- **W87 — Découpage de stats.js en 6 modules** — js_statsparams, js_statscharts, js_statssparkline, js_statssettings, js_stats, roadmap_w87_modularisation [EXTRACTED 1.00]
- **v5.33.0.0 — Trio W88 / W83-84 / W87** — roadmap_w88_pwa_shortcuts, roadmap_w83_w84_bilan_card, roadmap_w87_modularisation, changelog_v5330 [EXTRACTED 1.00]
- **W83/W84 — Câblage carte Bilan Google Sheets** — js_dashboardapi, js_stats_renderbilansheet, js_stats_initbilansheet, index_bilansheetcard, gas_action_builddashboard [EXTRACTED 1.00]
...
Cohesion: 0.06
Nodes (54): Constantes CO2 (W40/W51), DEFAULT_SURCONSO, getAllRecords(), buildBudgetBar(), buildBudgetTrend(), buildCo2Annuel(), buildCo2Monthly(), buildFuelSeries() (+46 more)
...
Cohesion: 0.12
Nodes (39): DOM helper functions, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (40): viewchange event, submitForm, checkDuplicate(), clearDraft(), _getClientId(), initVoiceKm(), onKmInput(), restoreDraft() (+32 more)
...
Cohesion: 0.09
Nodes (30): Pure utility functions, detectBrand(), buildComparatifCSV(), CMP_COLS, computeVehicleComparison(), exportComparatifCSV(), initComparatifExport(), _close() (+22 more)
...
Cohesion: 0.10
Nodes (29): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), escapeHtml(), estPleinValide(), _filteredRecords() (+21 more)
...
Cohesion: 0.13
Nodes (29): C9 reporté (compte de service Google), CHANGELOG — Suivi Conso Carburants, Artifact GAS Manager / gas-config.json, Top 5 recommandés (priorités ROADMAP), Axe Dev / Outillage Claude, Axe Web app, C11 — Cohérence FuelKeyK E10/GPLc, C4 Pouvoirs navigateur Claude in Chrome (+21 more)
...
Cohesion: 0.09
Nodes (27): BuildAggregates, BuildConsoBlock, BuildPriceBlockMerged, BuildVehiculesBlock, C1 — Libellés « Super 95/98 », G1 — listes déroulantes saisie Excel, G3 — dashboard natif Sheets, W81 — a11y WCAG AA gate bloquant (+19 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (26): v5.20.0.0, Tableau de bord Excel, Feuil3 (Tableau de bord), Filtres natifs dashboard (segments véhicule/carburant + chronologie), modDashboardGraphiques, modFiltres, ModuleImportGS, Carte Rentabilité kit E85 (+18 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (25): Historical price resolution — nearest-prior sector/station price for past fills, plein-added event, GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), initHistoireDelete(), refreshAfterPlein(), applyHistPriceToForm — fill form with historical price for past date (W60) (+17 more)
...
Cohesion: 0.11
Nodes (25): GS_Pleins (table Power Query), modSuiviVehicule.bas, _PrixHistory / PrixHistory (prix marche), v5.21.0.0, CHANGELOG v5.30.1.0, X47 clôturé — obsolète (économies E85/CO2 négatives), X48 — garde-fou en-tetes GS_Pleins (EnsureGSHeaders), scripts/check_vba_compile.py (X40 — lint VBA pré-commit) (+17 more)
...
Cohesion: 0.16
Nodes (19): A1 — date estimée de rentabilité, A2 — accessibilité ARIA des jauges, A3 — tooltip title de la jauge, buildRentaBar (js/stats.js), Coût total de conversion, Économie brute cumulée, Économie nette, Gate a11y W81 (+11 more)
...
Cohesion: 0.17
Nodes (12): js/cartealentour.js (carte alentour), Changelog Suivi E85, modFiltres.bas (filtres dashboard), CHANGELOG v5.13.0.0, v5.12.0.0 Filtres natifs du dashboard, v5.13.0.0, v5.20.0.0 Carte stations moins cheres (D3), Milestone v5.13.0.0 (X43 rebuild non bloquant) (+4 more)
...
Cohesion: 0.18
Nodes (11): CLAUDE.md — Instructions Claude Code, Docs de référence (docs/ARCHITECTURE…), Gate pré-commit /graphify --update, Langue de travail français obligatoire, Self-learning tasks/lessons.md, Versioning X.Y.Z.W + Conventional Commits, commit.sh (gate de commit), Navigation par vues (W42) (+3 more)
...
Cohesion: 0.29
Nodes (7): .bilan-* (css), #bilanSheetCard, buildCO2Tile(), renderBilanSheet(), renderStats(), buildCO2Tile(), buildRentaBar()
...
## Knowledge Gaps
- **892 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+887 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 23` to `Community 66`, `Community 69`, `Community 38`, `Community 8`, `Community 27`, `Community 76`, `Community 141`, `Community 142`, `Community 45`, `Community 54`, `Community 155`, `Community 156`, `Community 31`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 38` to `Community 152`, `Community 80`, `Community 60`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 68` to `Community 123`, `Community 97`, `Community 59`, `Community 13`?**
